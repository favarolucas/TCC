...
def load_data():
    with open(r"C:\Users\lucas\Documents\TCC\training_ds\centralized\training_seq0", "rb") as fp:
        training_sequences = pickle.load(fp)

    with open(r"C:\Users\lucas\Documents\TCC\training_ds\centralized\training_lab0", "rb") as fp:
