...
def load_data():
    with open(r"/home/favaro/TCCLucas/TCC/non_iid_rar/training_seq"+sys.argv[1], "rb") as fp:
        training_sequences = pickle.load(fp)

    with open(r"/home/favaro/TCCLucas/TCC/non_iid_rar/training_lab"+sys.argv[1], "rb") as fp:
...
def test(net,testloader,test_labels):
    ...
    with open("recall_non.txt", "a+") as file_object:
